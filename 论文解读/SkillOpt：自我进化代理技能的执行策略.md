...
| 3   | **松散自反思** | 没有老师指导自己瞎琢磨 | AI 自己干完活 -> 自己评价自己 -> 然后自己改，但**自然语言自由度太高**，没有约束的自我反思极易偏离最初目标，走着走着陷入逻辑死循环，彻底忘了最初要解决的业务是什么 |
...
##### 4. 内部优化循环一共分四个严密步骤
**数据集的划分作用**
![[论文解读/assets/SkillOpt：自我进化代理技能的执行策略/a17d693bfeaa6b0f094b5bcd989aeb45_MD5.png]]
![[论文解读/assets/SkillOpt：自我进化代理技能的执行策略/1c231eafdbc4fd6ee6fc657618da6065_MD5.png]]
![[论文解读/assets/SkillOpt：自我进化代理技能的执行策略/816a5733dafb74bb5d644d09b02aa337_MD5.png]]
...
| 机制名称 | 核心机制说明                                                                     |
| :--- | :------------------------------------------------------------------------- |
| 审计机制 | Epoch 末尾的纵向审计，**分析多个 Step 间的成功稳定性与性能退化区域，**识别真正有效的“共性规律”。                  |
| 空间锁定 | Markdown 受保护区域，通过特定**标签锁定核心技能文档**，Step 级编辑无法触碰，仅由跨 Epoch 的 Optimizer 统一调配。 |
| 知识固化 | 动量更新与规律指导，通过总结规律性指导，以慢速、高置信度的动量更新方式固化长期记忆，解决灾难性遗忘。                         |
